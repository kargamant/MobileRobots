...
namespace Robots
{
	...
	public:
		RobotDestroyer(int max_radius = 0, int velocity = 0, std::string name="c3po", double energy = 0, int slots = 1, int cost = 0, std::pair<int, int> coordinates = std::pair<int, int>(0, 0));
